  ...
  function getWeatherData(city) {
    ...
    fetch(url)
        ...
        .then(data => {
            ...
            document.querySelector('.informacoes-temperatura h3').textContent = `${data.main.temp}°`;

            // Atualizar a temperatura mínima
            document.getElementById('temperaturaMin').textContent = `${data.main.temp_min}° Celsius`;
            ...
            document.getElementById('descricaoClima').textContent = weatherDescription;
        })
        .catch(error => {
